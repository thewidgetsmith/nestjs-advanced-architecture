...
import { OrmUpsertMaterializedAlarmRepository } from './materialized-alarm.repository';
...
describe('OrmAlarmRepository', () => {
  let repository: OrmUpsertMaterializedAlarmRepository;
  ...
  beforeEach(async () => {
    ...
    repository = module.get<OrmUpsertMaterializedAlarmRepository>(
      OrmUpsertMaterializedAlarmRepository,
    );
